...
interface OrderPageContentProps {
    /** Whether to show the back link (hide when embedded in dashboard) */
...
export default function OrderPageContent({
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            {showBackLink && (
                <Link href={backLinkUrl} className="inline-flex items-center gap-2 text-zinc-400 hover:text-white mb-8 transition-colors">
